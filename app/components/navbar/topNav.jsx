...
const TopNav = () => {
  ...
  const goToRequestForm = () => {
    router.push("/AddRequest"); // Redirect to /request page
  };
  const goToRealOffer = () => {
    router.push("/RealOffer"); // Redirect to /request page
  };
  const goToMap = () => {
    router.push("/map"); // Redirect to /request page
  };
  return (
    <nav className="w-full px-4 sm:px-20 py-4 bg-content1 shadow-sm">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        {/* Logo */}
        <div className="flex items-center gap-2">
          <Image src="logo.png" alt="Logo" className="w-[60px] h-[60px]" />
          <span className="text-[18px] font-bold">Aqar com</span>
        </div>

        {/* Center Buttons */}
        <div className="hidden md:flex items-center gap-4">
          <Button variant="flat" onPress={goToMap} className="bg-white shadow-md px-4 py-2 rounded-lg text-sm font-medium">
            Search by Map
          </Button>
          ...
          <Button variant="flat" onPress={goToRealOffer} className="bg-white shadow-md px-4 py-2 rounded-lg text-sm font-medium">
         Real Offer
          </Button>
        </div>
